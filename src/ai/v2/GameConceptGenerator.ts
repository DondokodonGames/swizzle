...
✅ 実装可能: 「障害物が一定速度で流れてくるのを避けるゲーム」
- 「コーンが上から下へ流れてくる、車でよける」
- 「隕石が降ってくるのを宇宙船でよける」
- これらは move: straight + 画面外でteleportでループできます

ただし EditorMapper が移動ルールを正しく生成することが前提。
playerOperationには「左右にドラッグして避ける」と明記してください。
...
✅ 実装可能: 「障害物が一定速度で流れてくるのを避けるゲーム」
- 「コーンが上から下へ流れてくる、車でよける」→ ✅ move:straight + 画面外teleportでループ
- 「隕石が降ってくるのを宇宙船でよける」→ ✅ 同パターン
playerOperationには「左右にドラッグして避ける」と明記してください。
