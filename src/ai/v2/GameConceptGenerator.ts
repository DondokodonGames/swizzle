...
# 自由に考えてよいこと
- テーマ（何でもOK: 宇宙探検、深海、昆虫、天気、音楽、数学、忍者、妖怪、ロボット、植物、時間、重力、色彩、影、光...）
- ビジュアルスタイル（何でもOK: シンプル、派手、レトロ、モダン、ダーク、ネオン、水彩、8bit...）
- ゲームメカニクス（何でもOK: 既存の型にとらわれない）
- 世界観・ストーリー（何でもOK）

# 重要：多様性を保つ
毎回異なるテーマを選んでください。以下は避けてください：
- 寿司、料理、食べ物関連（過去に多用されたため）
- 一般的すぎるテーマ（フルーツキャッチなど）
