...
export class GameConceptGenerator {
  ...
  // テーマプール（コード側でランダム選択）
  private static readonly THEME_POOL = [
    // 宇宙・天体
    '星座', '流星群', 'ブラックホール', '彗星', '月面', '火星探査', '土星の輪', '銀河', '超新星爆発', '宇宙ステーション', '人工衛星', 'ロケット発射', '宇宙遊泳', '太陽フレア', 'オーロラ',
    // 深海・海洋
    '深海魚', 'クラゲ', 'タコ', 'イカ', 'サンゴ礁', '海底火山', 'マリアナ海溝', '沈没船', 'イルカ', 'クジラ', 'サメ', 'ウミガメ', '真珠',
    // 昆虫・小動物
    '蝶', '蜂', '蟻', 'カブトムシ', 'クワガタ', '蛍', 'トンボ', 'バッタ', 'カマキリ', 'テントウムシ', '蜘蛛', 'カタツムリ',
    // 鳥類
    'ペンギン', 'フクロウ', 'ワシ', 'タカ', 'ハチドリ', 'カラス', 'フラミンゴ', 'クジャク', 'オウム', '白鳥', '鶴',
    // 哺乳類
    '猫', '犬', 'うさぎ', 'ハムスター', 'リス', '狐', '狼', '熊', 'パンダ', 'コアラ', 'カンガルー', '象', 'キリン', 'ライオン', '虎',
    // 植物・花
    '桜', '向日葵', '薔薇', 'チューリップ', '蓮', '竹', '盆栽', 'サボテン', '食虫植物', 'キノコ', 'タンポポ', '紅葉',
    // 天気・気象
    '雷', '竜巻', '台風', '吹雪', '霧', '虹', '雲', '朝焼け', '夕焼け', '蜃気楼',
    // 音楽・楽器
    'ピアノ', 'バイオリン', 'ギター', 'ドラム', 'トランペット', 'フルート', 'ハープ', 'オルゴール', '太鼓', '三味線',
    // 数学・図形
    'フラクタル', '螺旋', '黄金比', '素数', '万華鏡', '幾何学模様',
    // 物理・科学
    '磁石', '電気', '原子', '結晶', 'プリズム', '振り子', '浮力',
    // 忍者・武士
    '手裏剣', '忍術', '煙玉', '刀', '弓矢', '城', '甲冑', '兜', '巻物',
    // 妖怪・伝説
    '河童', '天狗', '鬼', '狐の嫁入り', '座敷童', '一反木綿', 'ぬりかべ', '猫又', '雪女', '唐傘お化け',
    // ファンタジー
    'ドラゴン', 'ユニコーン', 'フェニックス', 'ペガサス', 'ゴーレム', 'エルフ', '魔法使い', '魔女', '妖精', '人魚', 'スライム',
    // ロボット・機械
    'アンドロイド', 'サイボーグ', 'ドローン', 'AI', '歯車', '時計仕掛け', '蒸気機関', '工場',
    // 乗り物
    '飛行機', '気球', '飛行船', 'ロケット', '潜水艦', '電車', '蒸気機関車', 'タイムマシン',
    // スポーツ
    'サッカー', '野球', 'バスケ', 'テニス', '卓球', 'ゴルフ', 'ボウリング', 'ダーツ', 'アーチェリー', 'フェンシング',
    // 建築・建造物
    '城', '寺院', '神社', 'ピラミッド', '塔', '灯台', '風車', '迷路', '秘密基地', 'ツリーハウス',
    // 玩具・ゲーム
    '積み木', 'ブロック', 'パズル', 'ルービックキューブ', 'けん玉', 'コマ', 'ヨーヨー', '風船', 'シャボン玉', '折り紙', '紙飛行機', '凧',
    // 宝石・鉱物
    'ダイヤモンド', 'ルビー', 'サファイア', 'エメラルド', '水晶', '金', '銀', '溶岩',
    // 抽象・概念
    '時間', '重力', '光', '影', '音', '静寂', 'カオス', 'バランス', '渦巻き', '波紋',
    // 場所・風景
    '砂漠', 'ジャングル', '草原', '洞窟', '火山', '滝', '氷河', 'オアシス', '島', '遺跡', '廃墟',
    // 祭り・イベント
    '花火大会', '盆踊り', '縁日', '運動会', 'クリスマス', 'ハロウィン', '七夕', 'お月見'
  ];
  ...
  private selectRandomTheme(): string {
    const availableThemes = GameConceptGenerator.THEME_POOL.filter(t => !this.usedThemes.has(t));
    if (availableThemes.length === 0) {
      this.usedThemes.clear(); // 全部使い切ったらリセット
      return GameConceptGenerator.THEME_POOL[Math.floor(Math.random() * GameConceptGenerator.THEME_POOL.length)];
    }
