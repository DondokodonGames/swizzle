...
(function(game) {
  ...
  game.onUpdate(function(dt) {
    if (state === S.ATTRACT) {
      ...
      game.draw.hand(demo.gxL + Math.cos(game.time.elapsed * 2.5) * 34, demo.gyL + 40 + Math.sin(game.time.elapsed * 2.5) * 34, { press: demo.press, scale: 13 });
      game.draw.hand(demo.gxR + Math.cos(game.time.elapsed * 2.5) * 34, demo.gyR + 40 + Math.sin(game.time.elapsed * 2.5) * 34, { press: demo.press, scale: 13 });
