...
`npm run games:list` 出力（2026-09-18・Phase 0 時点。再生成のたびに貼り替える）:

```
系統: (未分類) 35574 / 走る・跳ぶ 4919 / 球技・スポーツ 3981 / 探す・選ぶ 3579 / 盤・札 2888 /
      殴る・斬る 2223 / 競う速さ 1884 / 撃つ 1484 / 解く 1391 / 音に乗る 1073 / 賭け・運 931 /
      答える 692 / 育てる・回す 679 / 狩る・釣る 358 / その他 252
genre 実データ 11054 / 推定 15280 / tier1 0 / tier2 21824
```

未分類 35,574（57%）は genre が無くキーワードも当たらない行（DS・PS・PS2・アーケードに多い）。Phase 1 で推定を足して 20% 未満にする。
