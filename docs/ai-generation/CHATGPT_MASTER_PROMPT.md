...
**ジャンルとメカニクスは自由。固有名詞・キャラクター・特徴的な意匠は完全オリジナル。**

- 実在するゲームのタイトル名・キャラクター名・権利者名を、名前・説明・アセット・コメントに書かない
- 「〇〇風」という形で発想しない・名付けない
- 名前を消しても意匠が残っていればNG（赤白の球で捕獲 / 緑の土管と赤い帽子 / 迷路×ゴースト×エサ 等）
- 様式（ドット絵・CRT・チップチューン）と題材（ゾンビ・電車・廃墟）は借りてよい
- 例外: CAPCOM / SNK は許諾済み（指示に明記がある場合のみ）
